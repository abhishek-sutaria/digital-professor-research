...
import plaintext from "react-syntax-highlighter/dist/esm/languages/prism/plaintext";
import {
...
const resolveLanguage = (language?: string | null) => {
  if (!language) {
    return "plaintext";
  }
  ...
  if (part.executableCode) {
    return (
      <div className="part part-executableCode">
        ...
        <SyntaxHighlighter
          language={resolveLanguage(part.executableCode!.language)}
          style={dark}
        >
  ...
  if (part.codeExecutionResult) {
    return (
      <div className="part part-codeExecutionResult">
        ...
        <SyntaxHighlighter language={resolveLanguage("json")} style={dark}>
